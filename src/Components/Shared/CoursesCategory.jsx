    ...
    <div className="md:grid grid-cols-2 gap-5">
      {topics.map((e) => (
        <div key={e._id} className="card m-4 bg-gray-700 shadow-xl ">
          {console.log(e)}
          <img src={e.cover} alt="" className="p-8 rounded-t-lg" />
          <div className="px-5 pb-5">
            <h2 className="text-xl font-semibold tracking-tight text-gray-900 dark:text-white">
              {e.coursesName}
            </h2>
            <p className="text-lg font-medium tracking-tight text-gray-900 dark:text-white flex items-center">
              <FaUsers className="mx-2" />
              Students: {e.rating.count}
            </p>
            ...
            <div className="flex items-center justify-between">
              ...
              <Link className=" mb-0 " to={`/courseDetails/${e._id}`}>
