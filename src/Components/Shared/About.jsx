...
const About = () => {
    return (
        <div id='about' className='mt-24 w-full bg-gray-800 '>
	...
	<ul className="grid gap-3 md:grid-cols-2 lg:grid-cols-3 lg:px-24">
		<li className="flex items-center j space-x-2">
			<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" className="w-5 h-5 fill-current dark:text-accent">
