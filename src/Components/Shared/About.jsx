...
const About = () => {
    return (
        <div className='mt-24 w-full bg-gradient-to-r from-accent to-cyan-900 h-56'>
            <div className="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full md:px-24 lg:px-8 lg:py-20 bg-gradient-to-r from-accent to-cyan-900">
