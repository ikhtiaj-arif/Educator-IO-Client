    ...
    <div id="teachers" className=" mt-24">
      <div className="text-center p-10 ">
        <h1 className="text-5xl font-bold leading-none sm:text-4xl">
          We Provide <span className="text-accent"> The Best Teachers </span>
          <br />
          From All Around The Globe.
        </h1>
      </div>
      <div className="grid mb-8 border border-gray-200 rounded-lg shadow-sm dark:border-gray-700 w-full md:w-3/4 mx-auto md:mb-12 md:grid-cols-2">
