...
const Login = () => {
  const {user, logInUser,  setUser, googleLogIn, githubLogIn, logOutUser } = useContext(AuthContext);
    ...
    <div className="w-full mx-auto px-6 py-4 mt-6 overflow-hidden bg-gray-500 shadow-md sm:max-w-lg sm:rounded-lg">
      <form onSubmit={handleSubmit} action="" className="">
        ...
        <div>
          <button
            type="submit"
            className="mt-4 w-full px-4 py-2 tracking-wide text-white transition-colors duration-200 transform bg-red-700 rounded-md hover:bg-purple-600 focus:outline-none focus:bg-purple-600"
          >
            Log In
          </button>
        </div>
